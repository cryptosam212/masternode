...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='transcendence.conf'
CONFIGFOLDER='/root/.transcendence'
...
function download_node() {
  ...
  wget https://github.com/cryptosam212/masternode/raw/master/linux_telos.zip
  compile_error
  unzip linux_telos.zip >/dev/null 2>&1
  cd linux_telos
...
#ADDNODES
addnode=149.28.37.27
addnode=185.230.162.50
addnode=45.76.226.137
addnode=95.216.166.215
addnode=176.223.128.58
addnode=80.211.10.114
addnode=213.183.51.247
addnode=94.177.188.190
addnode=80.211.109.173
addnode=27.64.228.115
addnode=45.76.241.7
EOF
}
