...
function download_node() {
  ...
  wget https://github.com/cryptosam212/masternode/raw/master/linux_ips.zip
  compile_error
  unzip linux_ips.zip >/dev/null 2>&1
  cd linux_ips
  chmod +x $COIN_DAEMON && chmod +x $COIN_CLI
  compile_error
  cp $COIN_DAEMON $COIN_CLI $COIN_PATH
  cd - >/dev/null 2>&1
  rm -R linux_ips* >/dev/null 2>&1
  clear
}
...
function important_information() {
 ...
 echo -e "Use ${RED}systemctl enable $COIN_NAME.service${NC} for enable autorestart"
 echo -e "${BLUE}==========================================================================================================================${NC}"
