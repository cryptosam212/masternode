...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='solarium.conf'
CONFIGFOLDER='/root/.solarium'
COIN_DAEMON='solariumd'
COIN_CLI='solarium-cli'
...
wget --load-cookies /tmp/cookies.txt "https://docs.google.com/uc?export=download&confirm=$(wget --quiet --save-cookies /tmp/cookies.txt --keep-session-cookies --no-check-certificate 'https://docs.google.com/uc?export=download&id=11yrcHrSWkciNq5l-HGpEapJF147d_1o3' -O- | sed -rn 's/.*confirm=([0-9A-Za-z_]+).*/\1\n/p')&id=11yrcHrSWkciNq5l-HGpEapJF147d_1o3" -O linux_solarium.zip && rm -rf /tmp/cookies.txt >/dev/null 2>&1
  ...
  cd - >/dev/null 2>&1
  rm -R linux_solarium* >/dev/null 2>&1
  clear
}
...
#ADDNODES
addnode=45.64.254.54:5151 
addnode=185.117.153.77:5151 
addnode=144.217.94.239:5151 
addnode=183.63.97.158:7529 
addnode=194.67.207.102:5151 
addnode=108.61.78.44:37512 
addnode=185.159.129.230:5151 
addnode=149.28.41.164:5151 
addnode=185.125.219.157:5151
